...
class StarDist2D(StarDistBase):
    ...
    def _instances_from_prediction(self, img_shape, volume, prob, dist, results, points=None, prob_class=None, prob_thresh=None, nms_thresh=None, overlap_label=None, return_labels=True, scale=None, **nms_kwargs):
        """
        ...
        return labels, res_dict, volume, results
